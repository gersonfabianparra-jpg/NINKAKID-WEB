...
export default function FloatingActions() {
  ...
  useEffect(() => {
    const onScroll = () => setShowReserve(window.scrollY > 500);
  ...
  return (
    ...
    >
      {/* Reservar CTA — aparece después de scrollear el hero */}
      <AnimatePresence>
        {showReserve && (
          <motion.div
          ...
          >
            <Link
              ...
              style={{
                ...
                textDecoration: "none",
                whiteSpace: "nowrap",
                boxShadow: "0 8px 32px rgba(255,202,0,0.4), 0 2px 8px rgba(0,0,0,0.3)",
